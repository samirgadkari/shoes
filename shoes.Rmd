...
We're saying that any price that was increased was due to inelasticity.
...
was seen. Unfortunately, the processed dataset does not have
any prices column.

If I were working on this dataset, I would ask for that list.
We cannot proceed anymore along this line of enquiry since we cannot
tell if the price was decreased or increased. If the price was
decreased, we could say it is because it was too high for enough demand.
If the price was increased, we could say it was raised because
demand was not hurt. This second case is the inelastic pricing
we want to find.

## 2.4 When are prices changed?
